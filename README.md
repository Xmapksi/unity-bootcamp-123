...
- Sprint Retrospective: Oyunu geliştirmek ve daha iyi hale getirmek için elimizde hazır bulunan hikayenin oyuna aktarılması için çalışmalar sprint 2'nin başında başlamış olmalıydı, bu nedenle ekip içerisindeki iletişim kopukluklarının önüne geçmenin ne kadar önemli olduğunu gözlemlemiş olduk. Ayrıca daha önceden planlanılanılan birçok özellikten vazgeçilmek zorunda kalınması nedeniyle başta planlanılan yol haritasının sprintler içerisinde sık sık değişmesi, bizi daha esnek çalışmaya itti ve bu sayede deneyim kazanmış olduk.
